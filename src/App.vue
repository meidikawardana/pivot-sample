<template>
  <ejs-pivotview id="pivotview"
          ref="pivotview" :height="height" :width="width" :dataSourceSettings="dataSourceSettings" :allowExcelExport="allowExcelExport"
...
<script>
  import { PivotViewComponent, FieldList,
  Toolbar,
  PDFExport,
  ExcelExport,
  ...
  DrillThrough ,
  PivotView,
  VirtualScroll} from "@syncfusion/ej2-vue-pivotview";

PivotView.Inject(FieldList, DrillThrough, Toolbar,
  PDFExport,
  ExcelExport,
  ConditionalFormatting,
  NumberFormatting, VirtualScroll);
